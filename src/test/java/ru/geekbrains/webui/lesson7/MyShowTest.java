...
import ru.geekbrains.webui.lesson6.AbstractTest;
...
public class MyShowTest extends AbstractTest {
    ...
    void testFalse() throws InterruptedException, IOException {
        Thread.sleep(1000);
        File file = MyUtils.makeScreenshot(getWebDriver(),"failure- ru.geekbrains.webui.lesson7.MyShowTest.testFalse" + System.currentTimeMillis() + ".png");
